...
- [ ] #585 — Partager un résultat attendu entre plusieurs objectifs — sur un plan en brouillon, onglet « Stratégie opérationnelle » : cliquer 🔗 sur un résultat attendu, choisir un objectif d'un autre enjeu, valider. Le RA doit apparaître **sous les deux objectifs** avec le badge « Lié à plusieurs objectifs », et ses indicateurs doivent suivre. Modifier son libellé d'un côté : le changement doit se voir de l'autre. Vérifier ensuite : ⧉ (copier) crée au contraire un duplicata indépendant ; le bouton « retirer de cet objectif » n'apparaît que sous l'objectif de partage (pas sous celui où le RA a été créé), et le retrait laisse le RA en place ailleurs.
- [ ] #637 — Export du suivi des actions — sur un plan validé avec du suivi saisi : poser des filtres (enjeu, priorité, organisme, année, réalisation) + une recherche, aller au-delà de la page 1, puis cliquer « Exporter le tableau ». Le CSV doit s'ouvrir directement dans Excel (accents corrects, colonnes séparées) et contenir **toutes** les lignes filtrées — pas seulement la page affichée — avec le contenu de l'onglet actif (Réalisation / Budget / RH / Planification). Refaire onglet par onglet.
- [ ] #638 — Export du tableau de bord — poser un filtre d'objectif ou d'enjeu + une recherche, basculer entre les onglets État / Pression / Ensemble, puis cliquer « Exporter le tableau » (bout de la barre de filtres). Le CSV doit refléter l'onglet et les filtres, avec une colonne par année et les scores en libellé. Vérifier que les lignes de métriques sont présentes **même si les indicateurs sont repliés à l'écran** (choix assumé : le pliage n'est pas un filtre) — à confirmer côté produit.
- [ ] #639 — Export du bilan et filtre enjeu sur l'onglet Indicateurs — sur la page Bilan, sélectionner un enjeu dans « Enjeux/FCR » : les graphiques de l'onglet **Indicateurs** (donuts, radar) doivent maintenant changer, alors qu'ils restaient auparavant sur le plan entier. Changer ensuite la portée (Global / Mi-parcours / Annuel + année), puis cliquer « Exporter les résultats » : le CSV doit rappeler portée / année / enjeu en tête et contenir les deux volets (Indicateurs et Actions), sans les sections « par année » en portée Annuel.
- [ ] #639 — Export JPG des graphiques du bilan — « Exporter les résultats » ouvre désormais un menu : choisir « Graphiques (JPG) ». Le fichier téléchargé doit montrer les graphiques **de l'onglet affiché** tels qu'à l'écran (couleurs, hachures, libellés d'axes, légendes) avec, en tête, le plan et le rappel portée / année / enjeu. Refaire sur les deux onglets et avec un filtre enjeu posé : l'image doit suivre le filtre. Les tuiles sans graphique (Budget, RH en jours) et celles affichant « Aucune donnée » sont volontairement absentes de l'image — leurs chiffres sont dans le CSV.
- [ ] #643 — Design du tableau budgétaire (saisie de la fiche action) — ouvrir une action en mode « par organisme + type de budget + type de poste » (plan de démo « Ventilation — … ») : chaque organisme doit être coiffé d'un bandeau **vert pâle #C0E3CF** (texte bleu-vert), ses deux enveloppes « Budget prév. OG (€) Fonctionnement / Investissement » en **jaune #FEC180**, chaque sous-total « Total Budget de … (€) » en **jaune clair #FEDAB3**, et la ligne de clôture en **terra cotta #B74D5D texte blanc** libellée « Total \<nom exact de l'organisme\> » (et non plus « Budget total OG (€) »). Le bandeau **TOTAL** de fin de tableau reste bleu-vert #025359 texte blanc. Vérifier ensuite le mode « par type de budget + type de poste » (sans organisme) : mêmes couleurs d'enveloppes et de sous-totaux, et la dernière ligne « Budget prév. OG (€) TOTAL » en bleu-vert (pas en terra cotta, puisqu'elle ne clôt pas un organisme). La coloration doit couvrir la **première colonne** (libellés) autant que les cellules de valeurs.
- [ ] #659 — Pagination des pages d'administration — parcourir Administration > Utilisateurs, Sites, Plans, Organismes (et le suivi des actions d'un plan) : sous chaque tableau, la pagination doit afficher « 1-20 sur N » en gris à droite, la page courante en pastille bleu-vert #025359 texte blanc, les autres pages en blanc bordé de gris, et les chevrons précédent/suivant en bleu-vert sans bordure (grisés aux bornes). Plus aucun bouton « gris système » à bordure noire en relief. Survoler une page inactive (fond gris clair) et un chevron (halo bleu-vert léger). Sur un tableau de plus de 7 pages, les « … » doivent apparaître comme du texte gris non cliquable et la navigation rester fonctionnelle.
