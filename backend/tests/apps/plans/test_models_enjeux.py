...
from tests.factories.enjeux import (
    ...
    EtatActuelFactory, ObjectifLongTermeFactory, NiveauExigenceFactory,
...
class TestEtatActuelModel:
    ...
    def test_description_optional(self):
        """Test description is optional (null=True, blank=True)."""
        etat = EtatActuelFactory(description=None)
        assert etat.description is None

    def test_audit_dates_auto(self):
        """Test audit dates are auto-populated."""
        etat = EtatActuelFactory()
        assert etat.date_ajout is not None
        assert etat.date_maj is not None
...
class TestObjectifLongTermeModel:
    """Tests for the ObjectifLongTerme model."""
