...
Forme identique à celle de CICADA : c'est le même filtre « zone géographique »
qui est alimenté, que l'exploration soit servie par une instance ou par le hub.
Changer la forme ici obligerait le frontend à distinguer les deux cas, ce qui
est précisément ce que la bascule vers le hub doit éviter.
"""
