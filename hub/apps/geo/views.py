...
Une instance qui relaie l'exploration vers le hub doit aussi lui demander les
options de ses filtres, sans quoi l'arbre des zones proposé à l'utilisateur
viendrait d'une base et les résultats d'une autre.
"""
